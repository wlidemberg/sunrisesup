...
export function WaveIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12c.84 0 1.638-.347 2.215-.964.846-.906 2.05-1.411 3.285-1.411 1.236 0 2.44.505 3.286 1.41.577.618 1.375.965 2.214.965.84 0 1.638-.347 2.215-.964.846-.906 2.05-1.411 3.285-1.411 1.236 0 2.44.505 3.286 1.41.577.618 1.375.965 2.214.965" />
    </svg>
  );
}
...
export function QrCodeIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 013.75 9.375v-4.5zM3.75 14.625c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5a1.125 1.125 0 01-1.125-1.125v-4.5zM13.5 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 0113.5 9.375v-4.5zM13.5 13.5h1.5v1.5h-1.5v-1.5zM16.5 13.5h1.5v1.5h-1.5v-1.5zM15 15h1.5v1.5H15V15zM18 15h1.5v1.5H18V15zM13.5 16.5h1.5v1.5h-1.5v-1.5zM16.5 16.5h1.5v1.5h-1.5v-1.5zM15 18h1.5v1.5H15V18zM18 18h1.5v1.5H18V18z" />
    </svg>
  );
}
